...
if (isset($_SESSION['alert'])) {
    ...
    unset($_SESSION['alert']); // clear alert after showing it once
}
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <!--<< All Min Css >>-->
    <link rel="stylesheet" href="./Customer_theme/assets/css/all.min.css">
    <!--<< Animate.css >>-->
    <link rel="stylesheet" href="./Customer_theme/assets/css/animate.css">
    <!--<< Magnific Popup.css >>-->
    <link rel="stylesheet" href="./Customer_theme/assets/css/magnific-popup.css">
    <!--<< MeanMenu.css >>-->
    <link rel="stylesheet" href="./Customer_theme/assets/css/meanmenu.css">
    <!--<< Swiper Bundle.css >>-->
    <link rel="stylesheet" href="./Customer_theme/assets/css/swiper-bundle.min.css">
    <!--<< Nice Select.css >>-->
    <link rel="stylesheet" href="./Customer_theme/assets/css/nice-select.css">
    <!--<< Icomoon.css >>-->
    <link rel="stylesheet" href="./Customer_theme/assets/css/icomoon.css">
    <!--<< Main.css >>-->
    <link rel="stylesheet" href="./Customer_theme/assets/css/main.css">
</head>
...
<body>
                ...
                <div class="offcanvas__content">
                    <div class="offcanvas__top mb-5 d-flex justify-content-between align-items-center">
                        <div class="offcanvas__logo">
                            <a href="index.html">
                                <img src="./Customer_theme/assets/img/logo/black-logo.svg" alt="logo-img">
                            </a>
                        </div>
                            ...
                            <div class="header-left">
                                <div class="logo">
                                    <a href="index.html" class="header-logo">
                                        <img src="./Customer_theme/assets/img/logo/white-logo.svg" alt="logo-img">
                                    </a>
                                </div>
                                    ...
                                    <div class="header-humbager ml-30">
                                        <a class="sidebar__toggle" href="javascript:void(0)">
                                            <div class="bar-icon-2">
                                                <img src="./Customer_theme/assets/img/icon/icon-13.svg" alt="img">
                                            </div>
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="identityBox">
                        <div class="form-wrapper">
                            ...
                            <div>
                                <a class="another-option" href="https://www.google.com/">
                                    <img src="./Customer_theme/assets/img/google.png" alt="google">
                                    Continue With Google
                                </a>
                            </div>
                            <div>
                                <a class="another-option another-option-two" href="https://www.facebook.com/">
                                    <img src="./Customer_theme/assets/img/facebook.png" alt="google">
                        ...
                        <div class="banner">
                            ...
                            <button type="button" class="theme-btn rounded-0 register-btn" data-bs-toggle="modal"
                                ...
                                Account</button>
                            <div class="loginBg">
                                <img src="./Customer_theme/assets/img/signUpbg.jpg" alt="signUpBg">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="identityBox">
                        ...
                        <div class="banner">
                            ...
                            <button type="button" class="theme-btn rounded-0 register-btn" data-bs-toggle="modal"
                                ...
                                Account</button>
                            <div class="signUpBg">
                                <img src="./Customer_theme/assets/img/registrationbg.jpg" alt="signUpBg">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12 col-xl-8 col-lg-6">
                    <div class="hero-items">
                        <div class="book-shape">
                            <img src="./Customer_theme/assets/img/hero/book.png" alt="shape-img">
                        </div>
                        <div class="frame-shape1 float-bob-x">
                            <img src="./Customer_theme/assets/img/hero/frame.png" alt="shape-img">
                        </div>
                        <div class="frame-shape2 float-bob-y">
                            <img src="./Customer_theme/assets/img/hero/frame-2.png" alt="shape-img">
                        </div>
                        <div class="frame-shape3">
                            <img src="./Customer_theme/assets/img/hero/xstar.png" alt="img">
                        </div>
                        <div class="frame-shape4 float-bob-x">
                            <img src="./Customer_theme/assets/img/hero/frame-shape.png" alt="img">
                        </div>
                        <div class="bg-shape1">
                            <img src="./Customer_theme/assets/img/hero/bg-shape.png" alt="img">
                        </div>
                        <div class="bg-shape2">
                            <img src="./Customer_theme/assets/img/hero/bg-shape2.png" alt="shape-img">
                        </div>
                ...
                <div class="col-12 col-xl-4 col-lg-6">
                    <div class="girl-image">
                        <img class=" float-bob-x" src="./Customer_theme/assets/img/hero/hero-girl.png" alt="img">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="swiper book-slider">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="shop-box-items style-2">
                            <div class="book-thumb center">
                                <a href="shop-details-2.html"><img src="./Customer_theme/assets/img/book/01.png"
                                        alt="img"></a>
                                <ul class="post-box">
                                    <li>
                                        Hot
                                ...
                                <ul class="shop-icon d-grid justify-content-center align-items-center">
                                    ...
                                    <li>
                                        <a href="shop-cart.html">
                                            <img class="icon" src="./Customer_theme/assets/img/icon/shuffle.svg"
                                                alt="svg-icon">
                                        </a>
                                    </li>
                                    <li>
                            ...
                            <div class="shop-content">
                                ...
                                <ul class="author-post">
                                    <li class="authot-list">
                                        <span class="thumb">
                                            <img src="./Customer_theme/assets/img/testimonial/client-1.png" alt="img">
                                        </span>
                    ...
                    <div class="swiper-slide">
                        <div class="shop-box-items style-2">
                            <div class="book-thumb center">
                                <a href="shop-details-2.html"><img src="./Customer_theme/assets/img/book/02.png"
                                        alt="img"></a>
                                <ul class="shop-icon d-grid justify-content-center align-items-center">
                                    <li>
                                        <a href="shop-cart.html"><i class="far fa-heart"></i></a>
                            ...
                            <div class="shop-content">
                                ...
                                <ul class="author-post">
                                    <li class="authot-list">
                                        <span class="thumb">
                                            <img src="./Customer_theme/assets/img/testimonial/client-2.png" alt="img">
                                        </span>
                    ...
                    <div class="swiper-slide">
                        <div class="shop-box-items style-2">
                            <div class="book-thumb center">
                                <a href="shop-details-2.html"><img src="./Customer_theme/assets/img/book/03.png"
                                        alt="img"></a>
                                <ul class="shop-icon d-grid justify-content-center align-items-center">
                                    <li>
                                        <a href="shop-cart.html"><i class="far fa-heart"></i></a>
                            ...
                            <div class="shop-content">
                                ...
                                <ul class="author-post">
                                    <li class="authot-list">
                                        <span class="thumb">
                                            <img src="./Customer_theme/assets/img/testimonial/client-3.png" alt="img">
                                        </span>
                    ...
                    <div class="swiper-slide">
                        <div class="shop-box-items style-2">
                            <div class="book-thumb center">
                                <a href="shop-details-2.html"><img src="./Customer_theme/assets/img/book/04.png"
                                        alt="img"></a>
                                <ul class="post-box">
                                    <li>
                                        -12%
                            ...
                            <div class="shop-content">
                                ...
                                <ul class="author-post">
                                    <li class="authot-list">
                                        <span class="thumb">
                                            <img src="./Customer_theme/assets/img/testimonial/client-4.png" alt="img">
                                        </span>
                    ...
                    <div class="swiper-slide">
                        <div class="shop-box-items style-2">
                            <div class="book-thumb center">
                                <a href="shop-details-2.html"><img src="./Customer_theme/assets/img/book/05.png"
                                        alt="img"></a>
                                <ul class="shop-icon d-grid justify-content-center align-items-center">
                                    <li>
                                        <a href="shop-cart.html"><i class="far fa-heart"></i></a>
                            ...
                            <div class="shop-content">
                                ...
                                <ul class="author-post">
                                    <li class="authot-list">
                                        <span class="thumb">
                                            <img src="./Customer_theme/assets/img/testimonial/client-5.png" alt="img">
                                        </span>
                ...
                <div class="swiper book-catagories-slider">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="book-catagories-items">
                                <div class="book-thumb">
                                    <img src="./Customer_theme/assets/img/book-categori/03.png" alt="img">
                                    <div class="circle-shape">
                                        <img src="./Customer_theme/assets/img/book-categori/circle-shape.png"
                                            alt="shape-img">
                                    </div>
                        ...
                        <div class="swiper-slide">
                            <div class="book-catagories-items">
                                <div class="book-thumb">
                                    <img src="./Customer_theme/assets/img/book-categori/04.png" alt="img">
                                    <div class="circle-shape">
                                        <img src="./Customer_theme/assets/img/book-categori/circle-shape.png"
                                            alt="shape-img">
                                    </div>
    ...
    <section class="shop-section section-padding fix">
        <div class="container">
            ...
            <div class="book-shop-wrapper">
                <div class="shop-box-items style-2">
                    <div class="book-thumb center">
                        <a href="shop-details-2.html"><img src="./Customer_theme/assets/img/book/05.png" alt="img"></a>
                        <ul class="shop-icon d-grid justify-content-center align-items-center">
                            <li>
                                <a href="shop-cart.html"><i class="far fa-heart"></i></a>
                            </li>
                ...
                <div class="shop-box-items style-2">
                    <div class="book-thumb center">
                        <a href="shop-details-2.html"><img src="./Customer_theme/assets/img/book/04.png" alt="img"></a>
                        <ul class="post-box">
                            <li>
                                Hot
                            </li>
                ...
                <div class="shop-box-items style-2">
                    <div class="book-thumb center">
                        <a href="shop-details-2.html"><img src="./Customer_theme/assets/img/book/03.png" alt="img"></a>
                        <ul class="shop-icon d-grid justify-content-center align-items-center">
                            <li>
                                <a href="shop-cart.html"><i class="far fa-heart"></i></a>
                            </li>
                ...
                <div class="shop-box-items style-2">
                    <div class="book-thumb center">
                        <a href="shop-details-2.html"><img src="./Customer_theme/assets/img/book/02.png" alt="img"></a>
                        <ul class="post-box">
                            <li>
                                Hot
                            </li>
                ...
                <div class="cta-shop-box">
                    ...
                    <div class="girl-shape">
                        <img src="./Customer_theme/assets/img/girl-shape.png" alt="shape-img">
                    </div>
                    <div class="circle-shape">
                        <img src="./Customer_theme/assets/img/circle-shape.png" alt="shape-img">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="cta-banner-section fix section-padding pt-0">
        <div class="container">
            <div class="cta-banner-wrapper section-padding bg-cover"
                style="background-image: url('./Customer_theme/assets/img/cta-banner.jpg');">
                <div class="book-shape">
                    <img src="./Customer_theme/assets/img/book-shape.png" alt="shape-img">
                </div>
                <div class="girl-shape float-bob-x">
                    <img src="./Customer_theme/assets/img/girl-shape-2.png" alt="shape-img">
                </div>
                ...
                <div class="row">
                        ...
                        <div class="top-ratting-box-items">
                            <div class="book-thumb">
                                <a href="shop-details.html">
                                    <img src="./Customer_theme/assets/img/top-book/01.png" alt="img">
                                </a>
                            </div>
                    ...
                    <div class="col-xl-6 wow fadeInUp" data-wow-delay=".5s">
                        <div class="top-ratting-box-items">
                            <div class="book-thumb">
                                <a href="shop-details.html">
                                    <img src="./Customer_theme/assets/img/top-book/02.png" alt="img">
                                </a>
                            </div>
                            <div class="book-content">
                                <div class="title-header">
                    ...
                    <div class="col-xl-6 wow fadeInUp" data-wow-delay=".3s">
                        <div class="top-ratting-box-items">
                            <div class="book-thumb">
                                <a href="shop-details.html">
                                    <img src="./Customer_theme/assets/img/top-book/03.png" alt="img">
                                </a>
                            </div>
                            <div class="book-content">
                                <div class="title-header">
                    ...
                    <div class="col-xl-6 wow fadeInUp" data-wow-delay=".5s">
                        <div class="top-ratting-box-items">
                            <div class="book-thumb">
                                <a href="shop-details.html">
                                    <img src="./Customer_theme/assets/img/top-book/04.png" alt="img">
                                </a>
                            </div>
                            <div class="book-content">
                                <div class="title-header">
                    ...
                    <div class="col-xl-6 wow fadeInUp" data-wow-delay=".3s">
                        <div class="top-ratting-box-items">
                            <div class="book-thumb">
                                <a href="shop-details.html">
                                    <img src="./Customer_theme/assets/img/top-book/05.png" alt="img">
                                </a>
                            </div>
                            <div class="book-content">
                                <div class="title-header">
                    ...
                    <div class="col-xl-6 wow fadeInUp" data-wow-delay=".5s">
                        <div class="top-ratting-box-items">
                            <div class="book-thumb">
                                <a href="shop-details.html">
                                    <img src="./Customer_theme/assets/img/top-book/06.png" alt="img">
                                </a>
                            </div>
                            <div class="book-content">
                                <div class="title-header">
                            ...
                            <div class="client-info-wrapper d-flex align-items-center justify-content-between">
                                <div class="client-info">
                                    <div class="client-img bg-cover"
                                        style="background-image: url('./Customer_theme/assets/img/testimonial/01.jpg');">
                                        <div class="icon">
                                            <img class="shape" src="./Customer_theme/assets/img/testimonial/shape.svg"
                                                alt="img">
                                        </div>
                                    </div>
                                    <div class="content">
                                ...
                                <div class="logo">
                                    <img src="./Customer_theme/assets/img/testimonial/logo1.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="testimonial-card-items">
                            ...
                            <div class="client-info-wrapper d-flex align-items-center justify-content-between">
                                <div class="client-info">
                                    <div class="client-img bg-cover"
                                        style="background-image: url('./Customer_theme/assets/img/testimonial/02.jpg');">
                                        <div class="icon">
                                            <img class="shape" src="./Customer_theme/assets/img/testimonial/shape.svg"
                                                alt="img">
                                        </div>
                                ...
                                <div class="logo">
                                    <img src="./Customer_theme/assets/img/testimonial/logo2.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="testimonial-card-items">
                            ...
                            <div class="client-info-wrapper d-flex align-items-center justify-content-between">
                                <div class="client-info">
                                    <div class="client-img bg-cover"
                                        style="background-image: url('./Customer_theme/assets/img/testimonial/03.jpg');">
                                        <div class="icon">
                                            <img class="shape" src="./Customer_theme/assets/img/testimonial/shape.svg"
                                                alt="img">
                                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-card-items">
                            ...
                            <div class="client-info-wrapper d-flex align-items-center justify-content-between">
                                <div class="client-info">
                                    <div class="client-img bg-cover"
                                        style="background-image: url('./Customer_theme/assets/img/testimonial/04.jpg');">
                                        <div class="icon">
                                            <img class="shape" src="./Customer_theme/assets/img/testimonial/shape.svg"
                                                alt="img">
                                        </div>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="team-box-items">
                            <div class="team-image">
                                <div class="thumb">
                                    <img src="./Customer_theme/assets/img/team/01.jpg" alt="img">
                                </div>
                                <div class="shape-img">
                                    <img src="./Customer_theme/assets/img/team/shape-img.png" alt="img">
                                </div>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="team-box-items">
                            <div class="team-image">
                                <div class="thumb">
                                    <img src="./Customer_theme/assets/img/team/02.jpg" alt="img">
                                </div>
                                <div class="shape-img">
                                    <img src="./Customer_theme/assets/img/team/shape-img.png" alt="img">
                                </div>
                    ...
                    <div class="swiper-slide">
                        <div class="team-box-items">
                            <div class="team-image">
                                <div class="thumb">
                                    <img src="./Customer_theme/assets/img/team/03.jpg" alt="img">
                                </div>
                                <div class="shape-img">
                                    <img src="./Customer_theme/assets/img/team/shape-img.png" alt="img">
                                </div>
                    ...
                    <div class="swiper-slide">
                        <div class="team-box-items">
                            <div class="team-image">
                                <div class="thumb">
                                    <img src="./Customer_theme/assets/img/team/04.jpg" alt="img">
                                </div>
                                <div class="shape-img">
                                    <img src="./Customer_theme/assets/img/team/shape-img.png" alt="img">
                                </div>
                    ...
                    <div class="swiper-slide">
                        <div class="team-box-items">
                            <div class="team-image">
                                <div class="thumb">
                                    <img src="./Customer_theme/assets/img/team/05.jpg" alt="img">
                                </div>
                                <div class="shape-img">
                                    <img src="./Customer_theme/assets/img/team/shape-img.png" alt="img">
                                </div>
                    ...
                    <div class="swiper-slide">
                        <div class="team-box-items">
                            <div class="team-image">
                                <div class="thumb">
                                    <img src="./Customer_theme/assets/img/team/06.jpg" alt="img">
                                </div>
                                <div class="shape-img">
                                    <img src="./Customer_theme/assets/img/team/shape-img.png" alt="img">
                                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                    <div class="news-card-items">
                        <div class="news-image">
                            <img src="./Customer_theme/assets/img/news/09.jpg" alt="img">
                            <img src="./Customer_theme/assets/img/news/09.jpg" alt="img">
                            <div class="post-box">
                                Activities
                            </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".4s">
                    <div class="news-card-items">
                        <div class="news-image">
                            <img src="./Customer_theme/assets/img/news/10.jpg" alt="img">
                            <img src="./Customer_theme/assets/img/news/10.jpg" alt="img">
                            <div class="post-box">
                                Activities
                            </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".6s">
                    <div class="news-card-items">
                        <div class="news-image">
                            <img src="./Customer_theme/assets/img/news/11.jpg" alt="img">
                            <img src="./Customer_theme/assets/img/news/11.jpg" alt="img">
                            <div class="post-box">
                                Activities
                            </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".8s">
                    <div class="news-card-items">
                        <div class="news-image">
                            <img src="./Customer_theme/assets/img/news/12.jpg" alt="img">
                            <img src="./Customer_theme/assets/img/news/12.jpg" alt="img">
                            <div class="post-box">
                                Activities
                            </div>
    ...
    <footer class="footer-section footer-bg">
        ...
        <div class="footer-widgets-wrapper">
            <div class="plane-shape float-bob-y">
                <img src="./Customer_theme/assets/img/plane-shape.png" alt="img">
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
            ...
            <div class="container">
                <div class="footer-wrapper d-flex align-items-center justify-content-between">
                    ...
                    <ul class="brand-logo wow fadeInRight" data-wow-delay=".5s">
                        <li>
                            <a href="contact.html">
                                <img src="./Customer_theme/assets/img/visa-logo.png" alt="img">
                            </a>
                        </li>
                        <li>
                            <a href="contact.html">
                                <img src="./Customer_theme/assets/img/mastercard.png" alt="img">
                            </a>
                        </li>
                        <li>
                            <a href="contact.html">
                                <img src="./Customer_theme/assets/img/payoneer.png" alt="img">
                            </a>
                        </li>
                        <li>
                            <a href="contact.html">
                                <img src="./Customer_theme/assets/img/affirm.png" alt="img">
                            </a>
                        </li>
                    </ul>
                </div>
    ...
    <!--<< Bootstrap Js >>-->
    <script src="./Customer_theme/assets/js/bootstrap.bundle.min.js"></script>
    <!--<< Nice Select Js >>-->
    <script src="./Customer_theme/assets/js/jquery.nice-select.min.js"></script>
    <!--<< Waypoints Js >>-->
    <script src="./Customer_theme/assets/js/jquery.waypoints.js"></script>
    <!--<< Counterup Js >>-->
    ...
    <!--<< Wow Animation Js >>-->
    <script src="./Customer_theme/assets/js/wow.min.js"></script>
    <!-- Gsap -->
    <script src="./Customer_theme/assets/js/gsap.min.js"></script>
    <!--<< Main.js >>-->
    <script src="./Customer_theme/assets/js/main.js"></script>
</body>
<Script>    // Auto-hide alerts after 4 seconds
    setTimeout(() => {
...
<!-- Mirrored from gramentheme.com/html/bookle/index.html?storefront=envato-elements by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Sep 2025 05:33:42 GMT -->
